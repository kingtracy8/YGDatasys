...
public interface eskMapper {
    ...
    List<esk> selectAllEskFilter(@Param("start") Integer start, @Param("offset") Integer offset, @Param("content") String content, @Param("code") String code, @Param("result") String result);
}